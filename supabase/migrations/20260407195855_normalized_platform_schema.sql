...
-- Existing sample data in Bid/FarmCropType/Farm is dropped and should be re-seeded after apply.
...
ALTER TABLE "UserVerification" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "Farm" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "FarmParcel" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "CropType" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "FarmCropType" ENABLE ROW LEVEL SECURITY;
